        ...
        <div className="row">
          <h2>
            ...
            <div className="line sub">
              <span>
                I'm an experienced FrontEnd Developer with Backend development
                capabilities.
              </span>
            </div>
          </h2>
          <div className="btn-row">
            <a href="/resume-kasun_gunawardana.pdf" target="_blank">
          ...
          <div id="footerInfo">
            <div className="customized-row">
              <div className="customized-column col-lg-4 col-sm-12 col-xs-12">
                ...
                <p>
                  areducations.lk &nbsp;<span>// &nbsp;(React-Laravel)</span>
                </p>
                <p>
                  best4x4.com.au &nbsp;<span>// &nbsp;(React-Laravel)</span>
                </p>
              </div>
              <div className="customized-column col-lg-4 col-sm-12 col-xs-12">
                <h4>Currently At:</h4>
              ...
              <div className="customized-column col-lg-4 col-sm-12 col-xs-12">
                ...
                <ul>
                  <li>
                    <a
                      className="icons"
                      href="https://www.linkedin.com/in/kasun-gunawardana/"
                      target="_blank"
                    >
                  ...
                  <li>
                    <a
                      className="icons"
                      href="https://twitter.com/KasunGunawarda8"
                      target="_blank"
                    >
