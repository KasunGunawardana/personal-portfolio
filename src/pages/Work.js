...
const works = [
  {
    id: 1,
    name: 'intech.edu.lk',
    description: 'INTECH(Indeepa college of technology) is an institute with the vision of creating talented professionals in the area of IT/ Business & Engineering while enabling them to develop core competencies & skills towards the highly sophisticated professional carrier.',
  ...
  },
  {
    ...
    description: 'The Liberty in Learning Coalition is a growing group of associations, individuals, & home education curriculum providers in South Africa who share a common goal & are working for greater freedom in education.',
    url: null,
            ...
            <div className="work-wrapper customized-row">
              <div className="customized-column col-md-12 col-lg-7 col-xxl-7">
                <div className="tab-content">
                  { works.map((work) => (
                    <div key={work.id} className={ tabActive === work.id ? "tab-pane active" : "tab-pane"}>
              ...
              <div className="customized-column col-md-12 col-lg-5 col-xxl-5">
                <div className="nav-tabs">
                  { works.map((work) => (
                      <a key={work.id} className={ tabActive === work.id ? "process-item active" : "process-item"} 
                      onClick={() => {
