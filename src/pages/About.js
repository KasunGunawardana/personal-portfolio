      ...
      <div className='container'>
        <div className='row'>
          ...
          style={{ width: '100%' }}>
            ...
            <div>
            <p>I'm Kasun Gunawardana. I enjoy learning new skills and creating things that live on the internet. My interest in web development started back in 2017 while I was working for a company called Trade Promoters as an ERP administrator. They had a requerement for a small system to schedule/assign their technicials for each jobs and keep track on them. They also needed to revamp their existing outdated website. Since I come with an IT background, I knew some stuffs related to web development. So I had to do those stuffs while troubleshooting and resolving their ERP related problems. My knowledge of Web Development gradually increased ....</p>
            </div>
          </motion.div>
        </div>
      </div>
