      ...
      <div className='container'>
        <div className='row'>
          ...
          style={{ width: '100%' }}>
            ...
            <p className='about'>So I joined JP Web Solutions in 2019 and started my career as a web developer. First I was assigned to convert cheerful web designs (PSD, XD) to HTML/CSS (using bootstrap, materialize css) and add their CMS. After that they offered me trainings in Zend, Laravel php frameworks and then I was assigned to do further CMS developments/customizations like adding extra features/modules. Content coming soon...</p>
